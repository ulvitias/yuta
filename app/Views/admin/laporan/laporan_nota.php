    ...
    <div class="cor">
        <div class="kanan">
            <table>
                ...
                <tr class="tapal-lapor">
                    <td class="lapor" colspan="3">
                        LAPORAN DATA NOTA PINJAM PERPUSTAKAAN<br />
            ...
            <table class="daftar" border="1">
                ...
                foreach ($nota as $key => $data) { ?>
                    <tr>
                        ...
                        <td><?php echo $data['tgl_terlambat'] ?></td>
            ...
            <table>
                <tr>
                    <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </td>
                    <td><?php echo "Total Denda : Rp." . $total; ?></td>
                    <td class="tb-kanan">
