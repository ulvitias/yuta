        ...
        <div class="kembali-isi">
            ...
            ?>
                <ul class="isi">
                    ...
                    <li class="status">
                        <div class="border">
                            <form action="<?php echo base_url('/dashboard/dikembalikan/') ?>" method="POST">
                                <input type="hidden" name="kode" value="<?php echo $data['id_pinjam']; ?>" />
                                <input type="hidden" name="id_buku" value="<?php echo $data['id_buku']; ?>" />
                                <input type="text" name="hilang" class="ifYes" style="float:left;  width: 50%; height: 30px;" placeholder="Rp. jika hilang" autocomplete="off" />
